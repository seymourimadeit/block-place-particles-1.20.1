package tallestred.blockplaceparticles.particle.spark;
...
public class FlyingSpark extends StretchyBouncyShapeParticle {
    ...
    protected int getShortenedAge() {
        return (int) Mth.clamp((long) this.age * (this.hasEnteredWater ? SPARK_UNDERWATER_DECAY_SPEED : 1), 0, this.lifetime);
    }
