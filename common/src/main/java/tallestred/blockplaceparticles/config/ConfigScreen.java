...
import tallestred.blockplaceparticles.config.controller.BlockLocationController;
import tallestred.blockplaceparticles.config.controller.FluidLocationController;
...
public class ConfigScreen {
    ...
    public static OptionGroup createSeparator() {
        return OptionGroup.createBuilder()
            .name(Component.translatable("eg_particle_interactions.config.category_separator").setStyle(Style.EMPTY.withColor(0xff6c6c6c)))
            .collapsed(true)
            .option(LabelOption.createBuilder().line(Component.empty()).build())
        .build();
    }
